...
export default function Carousel() {
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto overflow-hidden pb-10 mb-8 md:mb-0">
          ...
          >
            ...
            <div className="relative overflow-hidden">
              ...
              <motion.img
                src={slide.image}
                alt={slide.caption}
                className="w-full h-48 md:h-56 lg:h-64 object-cover object-center transition-transform duration-500"
      ...
      <motion.button
        onClick={() => scroll("left")}
        className="absolute left-2 md:left-3 top-1/2 -translate-y-1/2 bg-white/95 hover:bg-white p-3 md:p-2 rounded-full shadow-xl z-30 transition-all duration-300 backdrop-blur-sm border border-gray-200/50 min-h-[48px] min-w-[48px] md:min-h-auto md:min-w-auto flex items-center justify-center"
      ...
      <motion.button
        ...
        className="absolute right-2 md:right-3 top-1/2 -translate-y-1/2 bg-white/95 hover:bg-white p-3 md:p-2 rounded-full shadow-xl z-30 transition-all duration-300 backdrop-blur-sm border border-gray-200/50 min-h-[48px] min-w-[48px] md:min-h-auto md:min-w-auto flex items-center justify-center"
      ...
      <motion.div
        className="absolute bottom-[-23px] z-10 md:bottom-2 left-1/2 transform -translate-x-1/2 flex gap-3 md:gap-2 bg-white/90 backdrop-blur-sm px-4 py-2.5 my-5 md:px-3 md:py-1.5 rounded-full shadow-lg border border-white/30"
        initial={{ opacity: 0, y: 20 }}
      ...
      >
        {guideSteps.map((_, index) => (
          <motion.button
            ...
            className={`w-3 h-3 md:w-2 md:h-2 rounded-full transition-all duration-300 min-h-[12px] min-w-[12px] ${
              index === currentSlide
